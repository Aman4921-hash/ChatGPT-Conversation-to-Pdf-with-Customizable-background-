...
(function() {
    ...
    // Initial style; will be updated by updateToggleButtonStyle().
    ...
    function updateToggleButtonStyle() {
        if(window.innerWidth < 480) {
            // For small screens (phones), position at bottom right.
            ...
            // For desktops, position at the right middle edge.
    ...
    window.addEventListener('resize', updateToggleButtonStyle);

    /***********************
     *  OPTIONS PANEL (Centered)
     ***********************/
     ...
     *  PANEL TOGGLE LOGIC
     ***********************/
    // Show the panel when the toggle button is clicked.
    ...
    async function generatePdf() {
        ...
        // Calculate available content width based on page size and margin.
        let contentWidthInInches = (settings.orientation === 'portrait' ? 8.5 : 11) - 2 * settings.margin;
